...
class UdpClient
{
    ...
    public function __construct(UdpServiceFinder $finder, string $clientNodeId)
    {
        $this->config = $finder;
        $this->clientNodeId = $clientNodeId;
    }

    public function send(UdpPack $pack, string $address, int $port)
    {
    ...
    public function broadcast(UdpPack $pack)
    {
