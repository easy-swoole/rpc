...
$config->setExtra(['host' => '127.0.0.1', 'port' => 6379]);
$rpc = new Rpc($config);
...
$configTwo->setExtra(['host' => '127.0.0.1', 'port' => 6379]);
$configTwo->setServiceName('ser2');

$configTwo->setNodeManager(\EasySwoole\Rpc\NodeManager\RedisManager::class);
